...
<!-- 承辦人:<select id="contractor"><option value="0">請先選擇部門</option></select><br><br> -->
服務需求:<br>
<textarea id="demand" placeholder="問題說明" value=""></textarea><br><br>
<!-- 服務類別:<select id="serviceType"><option value="0">選擇服務類別</option></select><br><br> -->
<!-- 事件類別: -->
<!-- <select id="eventType" onchange="infoSecurity()"> -->
<!--     <option value="0">選擇事件類別</option> -->
<!--     <option value="建議事項">建議事項</option> -->
<!--     <option value="非資安事件">非資安事件</option> -->
<!--     <option value="資安事件">資安事件</option> -->
<!-- </select><br><br> -->
<!-- <form id="security"></form><br><br> -->
