...
function addList(data){
	...
	bodyHTML += '<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="detail(' + data.id + ')">查看</button></td></tr>'
...
function stage3(data){
    ...
    form += '<div><span>處理方式:&nbsp;&nbsp;</span><textarea id="processWay"></textarea></div><br><div><span>執行開始時間:&nbsp;&nbsp;</span><input type="text" id="pStartTime" value="" placeholder="yyyy-MM-dd HH:mm" /></div><br><div><span>執行完成時間:&nbsp;&nbsp;</span><input type="text" id="pEndTime" value="" placeholder="yyyy-MM-dd HH:mm" /></div><br><div><span>矯正措施:&nbsp;&nbsp;</span><textarea id="correction"></textarea></div><br><div><span>預定完成時間:&nbsp;&nbsp;</span><input type="text" id="cEstimated" value="" placeholder="yyyy-MM-dd HH:mm" /></div><br><div><span>實際完成時間:&nbsp;&nbsp;</span><input type="text" id="cActual" value="" placeholder="yyyy-MM-dd HH:mm" /></div><br><div><span>改善措施:&nbsp;&nbsp;</span><textarea id="improvement"></textarea></div><br><div><span>預定完成時間:&nbsp;&nbsp;</span><input type="text" id="iEstimated" value="" placeholder="yyyy-MM-dd HH:mm" /></div><br><div><span>實際完成時間:&nbsp;&nbsp;</span><input type="text" id="iActual" value="" placeholder="yyyy-MM-dd HH:mm" /></div><br><div><span>驗證人員:&nbsp;&nbsp;</span><select id="verificationId"><option value="0">請選擇驗證人員</option></select></div><br><div id="remark"></div><br>';
    $('#form').html('');
    $('#form').append(form);
    serviceType();
...
<!-- list -->
<table border="1">
<thead><tr><th>申請單列表</th><th></th></tr></thead>
<tbody id="tbody">
