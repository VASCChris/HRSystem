...
function list() {
	$.ajax({
        ...
        success: function (data) {
        	...
        	bodyHTML += '<tr><td><input type="text" id="no" value=""></td>';
        	bodyHTML += '<td><input type="text" id="name" value=""></td>';
        	bodyHTML += '<td><input type="text" id="supervisor" value=""></td>';
        	bodyHTML += '<td><button type="button" name="send" onclick="update()">修改</button></td>';
        	bodyHTML += '<td><button type="button" name="send" onclick="depDel()">刪除</button></td></tr>';
...
function addDep(data){
	...
	bodyHTML += '<td>'+ data.supervisor +'</td></tr>';
	$('#depList').append(bodyHTML);
}
